...
export default function Client({ redirectTo, flashStatus, flashMessage }: ClientProps) {
  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Create a MailForge Account",
        description: "Start building, sending, and tracking campaigns in minutes.",
      };
    }
    ...
    return {
      ...
      description: "Access your campaigns, contacts, and analytics.",
    };
  }, [mode]);
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Simplify your email marketing with MailForge.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Powerful, intuitive tools to create, send, and analyze campaigns—trusted by small businesses and growing brands.
              </p>
            </div>
